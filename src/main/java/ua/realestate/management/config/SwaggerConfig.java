...
public class SwaggerConfig {
    ...
    public Docket api() {
        return new Docket(DocumentationType.SWAGGER_2)
                .groupName("SpringBoot-Swagger_API")
                .ignoredParameterTypes(SecurityUserEntity.class)
                .select()
                .apis(RequestHandlerSelectors.basePackage("ua.realestate.management.controller"))
                .build()
